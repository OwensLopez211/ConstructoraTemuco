...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', 'required', 'in:' . implode(',', array_keys(Project::TYPES))],
            'status' => ['sometimes', 'required', 'in:' . implode(',', array_keys(Project::STATUSES))],
            'location' => ['sometimes', 'required', 'string', 'max:255'],
            'budget' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:999999999999.99'],
            'start_date' => ['sometimes', 'nullable', 'date', 'after_or_equal:2020-01-01'],
            'end_date' => ['sometimes', 'nullable', 'date', 'after:start_date'],
            'estimated_end_date' => ['sometimes', 'nullable', 'date', 'after:start_date'],
